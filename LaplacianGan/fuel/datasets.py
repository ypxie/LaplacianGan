...
class Dataset(object):
    ...
    def next_batch(self, batch_size, window):
        ...
        #images_dict['output_16'] = imresize_shape(sampled_images, (16, 16)).transpose((0, 3, 1,2) )
        ...
        #wrongs_dict['output_16'] = imresize_shape(sampled_wrong_images,(16, 16)).transpose((0, 3, 1,2) )

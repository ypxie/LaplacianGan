...
CUDA_VISIBLE_DEVICES=${device} python train.py --batch_size 16 --imsize ${D} --model_name ${name} --which_disc origin --load_from_epoch ${epoch} --reuse_weights --g_lr 0.000025 --d_lr 0.000025 | tee ${root}/${folder}/log.txt

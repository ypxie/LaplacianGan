...
from LaplacianGan.stackModels import Discriminator as Disc
from LaplacianGan.stackModels import Generator as Gen
...
if  __name__ == '__main__':
    ...
    model_root, model_name = 'model', 'lapgan_{}_{}'.format(data_name, img_size)

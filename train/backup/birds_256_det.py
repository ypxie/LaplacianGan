...
from LaplacianGan.models.detModels import Discriminator as Disc
from LaplacianGan.models.detModels import Generator as Gen
...
if  __name__ == '__main__':
    ...
    model_root, model_name = 'model', 'lap__det_gan_{}_{}'.format(data_name, img_size)

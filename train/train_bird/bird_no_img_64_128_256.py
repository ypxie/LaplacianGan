...
local_bug_no_img_64_128_256  = {  'reuse_weights': True, 'batch_size': 16, 'device_id': 0, 'dataset':'birds',
                            'g_lr': .0002/(2**0),'d_lr': .0002/(2**0), 'use_img_loss' : False,
                            'imsize':[64, 128, 256], 'load_from_epoch': 51, 'model_name':'gen_origin_disc_local_bug_no_img', 
                            'which_gen': 'origin', 'which_disc':'local', 'reduce_dim_at':[8, 32, 128, 256]}

training_pool = np.array([
                  local_bug_no_img_64_128_256
                 ])

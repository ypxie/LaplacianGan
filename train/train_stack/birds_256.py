...
import sys, os
sys.path.insert(0, os.path.join('..', '..', 'laplacianGan'))
...
from laplacianGan.stackGan import train_gans
...
if  __name__ == '__main__':
    ...
    netD = Disc(input_size = img_size, num_chan = 3, hid_dim = 64, 
                sent_dim=1024, enc_dim = 256, emb_dim= 128,  norm=norm)
    ...
    model_name = 'lapgan_{}_{}_{}'.format(data_name, img_size, norm)

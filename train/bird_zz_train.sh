...
CUDA_VISIBLE_DEVICES=${device} python train.py --dataset birds --batch_size 16 --imsize ${D} --model_name ${name} --reuse_weights --load_from_epoch 100 --g_lr 0.0001 --d_lr 0.0001 --reuse_weights --load_from_epoch 100 --g_lr 0.0001 --d_lr 0.0001 | tee ${root}/${folder}/log.txt

...
if  __name__ == '__main__':
    ...
    if not args.debug_mode:
        ...
        train_loader = MultiThreadLoader('Data/coco/train', batch_size=args.batch_size, num_embed=4, threads=3, test_mode=False).load_data()
        test_loader = MultiThreadLoader('Data/coco/train', batch_size=args.batch_size, num_embed=1, threads=3, test_mode=True).load_data()

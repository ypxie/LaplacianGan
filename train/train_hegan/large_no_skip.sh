...
python bird_train.py --device_id 2 --emb_interp --batch_size 16 --num_emb 4 --imsize 256 --model_name ${name} --load_from_epoch 3 --which_gen ${gen} --which_disc ${disc} --save_freq 1

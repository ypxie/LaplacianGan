...
CUDA_VISIBLE_DEVICES=${device} python bird_zz_train.py --batch_size 8 --imsize ${D} --model_name ${name} --reuse_weigths --load_from_epoch ${epoch} --which_gen origin_no_skip 

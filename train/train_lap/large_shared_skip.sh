...
name='large_skip'
python bird_zz_train.py --device_id 2 --emb_interp --batch_size 8 --num_emb 4 --imsize 128 --model_name ${name}  --load_from_epoch 26 --which_gen ${name} --which_disc ${name} --save_freq 1
